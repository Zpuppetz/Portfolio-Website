...
export function MacbookScrollDemo() {
  return (
    <div className="w-full overflow-hidden bg-yellow-100 dark:bg-[#0B0B0F]">
      <MacbookScroll
        title={
          <span className="text-5xl font-bold underline font-sans">
            Keshav Gupta  <br /> 
            <span className="text-3xl font-normal underline font-serif">
                Backend Developer
            </span>
          </span>
        }
