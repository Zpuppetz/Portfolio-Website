      ...
      <section id="certifications" className="w-full py-20 px-4 bg-gradient-to-b from-black via-slate-900 to-black min-h-screen">
        <div className="w-full max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="group relative bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 hover:bg-white/10 hover:border-purple-500/30 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-purple-500/20">
              ...
              <h3 className="text-xl font-bold text-white mb-2 group-hover:text-purple-300 transition-colors">AWS Cloud Practitioner</h3>
              <p className="text-gray-400 text-sm mb-4">Amazon Web Services</p>
              <div className="flex items-center gap-2 text-xs text-gray-500">
                <span className="px-3 py-1 rounded-full bg-violet-500/20 text-violet-300">2024</span>
                <span className="px-3 py-1 rounded-full bg-white/10 text-gray-300">Cloud</span>
              </div>
            </div>

            {/* Certification Card 2 */}
            <div className="group relative bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 hover:bg-white/10 hover:border-blue-500/30 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-blue-500/20">
              <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-blue-500/20 to-transparent rounded-bl-full" />
              <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center mb-4 shadow-lg shadow-blue-500/30 group-hover:scale-110 transition-transform duration-300">
                <svg className="w-7 h-7 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                </svg>
              </div>
              <h3 className="text-xl font-bold text-white mb-2 group-hover:text-blue-300 transition-colors">React Developer</h3>
              <p className="text-gray-400 text-sm mb-4">Meta Certification</p>
              <div className="flex items-center gap-2 text-xs text-gray-500">
                <span className="px-3 py-1 rounded-full bg-blue-500/20 text-blue-300">2024</span>
                <span className="px-3 py-1 rounded-full bg-white/10 text-gray-300">Frontend</span>
              </div>
            </div>

            {/* Certification Card 3 */}
            <div className="group relative bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 hover:bg-white/10 hover:border-emerald-500/30 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-emerald-500/20">
              ...
              <h3 className="text-xl font-bold text-white mb-2 group-hover:text-emerald-300 transition-colors">MongoDB Developer</h3>
              <p className="text-gray-400 text-sm mb-4">MongoDB University</p>
              <div className="flex items-center gap-2 text-xs text-gray-500">
                <span className="px-3 py-1 rounded-full bg-emerald-500/20 text-emerald-300">2023</span>
                <span className="px-3 py-1 rounded-full bg-white/10 text-gray-300">Database</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="relative">
            ...
            <div className="relative flex flex-col md:flex-row items-start md:items-center mb-12 pl-8 md:pl-0">
              <div className="md:w-1/2 md:pr-12 md:text-right order-2 md:order-1">
                <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 hover:bg-white/10 hover:border-purple-500/30 transition-all duration-500 hover:shadow-xl hover:shadow-purple-500/10">
                  <span className="inline-block px-3 py-1 rounded-full bg-violet-500/20 text-violet-300 text-xs mb-3">2024 - Present</span>
                  <h3 className="text-xl font-bold text-white mb-1">Senior Full Stack Developer</h3>
                  <p className="text-purple-400 font-medium mb-3">Tech Company Inc.</p>
                  <p className="text-gray-400 text-sm">Led development of scalable web applications using React, Node.js, and cloud technologies. Mentored junior developers and improved team productivity by 40%.</p>
                </div>
              </div>
            ...
            <div className="relative flex flex-col md:flex-row items-start md:items-center mb-12 pl-8 md:pl-0">
              ...
              <div className="md:w-1/2 md:pl-12 order-2 md:order-3">
                <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 hover:bg-white/10 hover:border-purple-500/30 transition-all duration-500 hover:shadow-xl hover:shadow-purple-500/10">
                  <span className="inline-block px-3 py-1 rounded-full bg-purple-500/20 text-purple-300 text-xs mb-3">2022 - 2024</span>
                  <h3 className="text-xl font-bold text-white mb-1">Full Stack Developer</h3>
                  <p className="text-purple-400 font-medium mb-3">Startup Solutions</p>
